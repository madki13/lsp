                            ...
                            <div class="table-responsive">
                                <form action="{{ route('transaksi.store') }}" method="post">
                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="number" name="qty" class="form-control" id="qty" placeholder="Qty" min="0" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
...
<script>
    function validateQty() {
      ...
      if (qtyValue === 0) {
        alert('Jumlah tiket (Qty) tidak boleh 0. Silahkan masukkan nilai minimal 1.');
